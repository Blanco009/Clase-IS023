...
public class PopUpMessages {
    ...
    // Pop up window that receive the answer, of what the user wants to modify, been
    // row or column.
    public String rowOrColumnSelection() {
        ...
        do {
            ...
            // if the user select "F" or "f", that char is changed to the string "Fila", and
            // "C" or "c" to "Columna"
    ...
    // method to do the question of what R/C number wants to be modified and receive
    // the reply.
    public int rowOrColumnNumber(String letterSelection) {
        // in this section is the Question of the ¿number? of Row or Column the user
        // wants to sort
        int finalSelection = 0;
        int status = 1;
        do {
            finalSelection = Integer.parseInt(
                    JOptionPane.showInputDialog("Digite Una " + letterSelection + " Que Desea Modificar " + " [1-4]"));
...
}// Brayan Araya y Jonathan Blandon
